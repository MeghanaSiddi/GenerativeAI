...
def ask(
    ...
    # 2. Create retriever . Below line is runnable and we can do .invoke() on this
    retriever=vector_store.as_retriever()

    # 3. create a RAG prompt
    rag_prompt=ChatPromptTemplate.from_template("""
    Answer the question based only on the provided context below.
    If the context doesnot contain enough information to answer
    say I don't know rather than guessing or using outside knowledge
    ...
    print(f"Response from vector store is {context}")
